        ...
        while i < len(dados):
            ...
            if str(dados.iloc[i, 3]).strip().lower() == "nome":
                ...
                while i < len(dados):
                    ...
                    # Verifica os valores em "Vencimentos" (coluna Z, índice 25) e "Descontos" (coluna AH, índice 33)
                    ...
                    # Adiciona a descrição e os valores correspondentes ao dicionário do funcionário
        ...
        for nome, registros in dados_processados.items():
            for registro in registros:
                linhas.append({
                    ...
                    "Vencimentos": registro["Vencimentos"],
    ...
    if isinstance(dados_processados, dict):
        for nome, registros in dados_processados.items():
            ...
            for registro in registros:
                ...
                print(f"    Vencimentos: {registro['Vencimentos']}")
                print(f"    Descontos: {registro['Descontos']}")
